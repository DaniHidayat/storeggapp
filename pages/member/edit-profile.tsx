                ...
                <div className="ps-lg-0">
                    ...
                    <div className="bg-card pt-30 ps-30 pe-30 pb-30">
                        <form action="">
                            <div className="photo d-flex">
                                ...
                                <div className="image-upload">
                                    <label htmlFor="avatar">
                                        {imagePreview ? (
                                            <img src={imagePreview} style={{borderRadius:'100%'}} alt="icon-upload" width={90} height={90} />
                                        ):(
                                                                
                                        <img src={`${IMG}${user.avatar}`} style={{borderRadius:'100%'}} alt="icon-upload" width={90} height={90} />
                                        )}
                            ...
                            <div className="pt-30">
                                <Input label="Email Adrres" value={user.email} disabled />
                            </div>
                            {/* <div className="pt-30">
                                <Input label="Phone" />
                            </div> */}
